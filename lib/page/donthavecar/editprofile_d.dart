...
class EditProfileD extends StatefulWidget {
  const EditProfileD({super.key});

  @override
  State<EditProfileD> createState() => _EditProfileDState();
}

class _EditProfileDState extends State<EditProfileD> {
  late String fullname, email, bank;
  @override
